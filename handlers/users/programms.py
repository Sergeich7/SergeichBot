...
<b><i>Ять</i></b> - база данных ресторана разработана на СУБД PostgreSQL в рамках аттестационной работы курса "Базы данных. SQL" РАНХиГС. Для её создания и наполнении данными использовались хранимые процедуры, триггеры и исполняемые блоки написанные на PL/pgSQL.
